...
PeryashkinVBinaryComponentContourProcessingSTL::PeryashkinVBinaryComponentContourProcessingSTL(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput().clear();
}

bool PeryashkinVBinaryComponentContourProcessingSTL::ValidationImpl() {
...
bool PeryashkinVBinaryComponentContourProcessingSTL::PreProcessingImpl() {
  local_out_.clear();
  return true;
}

bool PeryashkinVBinaryComponentContourProcessingSTL::RunImpl() {
  if (!ValidationImpl()) {
    return false;
  }
...
bool PeryashkinVBinaryComponentContourProcessingSTL::PostProcessingImpl() {
